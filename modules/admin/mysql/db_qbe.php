                ...
                for ($x = 0; $x < $col; $x++) {
                    ...
                    <td align="center">
                        ...
                        <input type="text" name="criteria[<?php echo $z; ?>]"
                               value="<?php echo htmlspecialchars($stripped_Criteria); ?>" class="textfield"
                               style="width: <?php echo $realwidth; ?>" size="20"/>
                    </td>
                    <?php
                    $z++;
            ...
            for ($y = 0; $y <= $row; $y++) {
                    ...
                    <tr class="<?php echo $odd_row ? 'odd' : 'even'; ?> noclick">
                        ...
                        for ($x = 0; $x < $col; $x++) {
                            if (isset($ins_col[$x]) && $ins_col[$x] == 'on') {
                                ...
                                ?>
                                <td align="center">
                                    <textarea cols="20" rows="2" style="width: <?php echo $realwidth; ?>"
                                              name="<?php echo $or; ?>" dir="<?php echo $text_dir; ?>"></textarea>
                                </td>
                                <?php
                                $z++;
                            } // end if
                ...
                <tr class="<?php echo $odd_row ? 'odd' : 'even'; ?> noclick">
                    ...
                    for ($x = 0; $x < $col; $x++) {
                        ...
                        <td align="center">
                            <textarea cols="20" rows="2" style="width: <?php echo $realwidth; ?>"
                                      name="Or<?php echo $w . '[' . $z . ']'; ?>"
                                      dir="<?php echo $text_dir; ?>"><?php echo htmlspecialchars($stripped_or); ?></textarea>
                        </td>
                        <?php
                        if (!empty(${$or}) && isset(${$or}[$x])) {
                            ${'cur' . $or}[$z] = ${$or}[$x];
