        ...
        <div id="id_scroll_tab" class="scroll_tab">
            <table width="100%" style="padding-left: 3px;">
                ...
                for ($i = 0; $i < $name_cnt; $i++) {
                    ?>
                    <tr>
                        <td title="<?php echo $strStructure; ?>" width="1px"
    ...
    <tr>
        ...
        <td class="input_tab">
            <table width="168" border="0" align="center" cellpadding="2" cellspacing="0">
                <thead>
                <tr>
                    <td colspan="2" align="center" nowrap="nowrap"><strong><?php echo $strCreateRelation; ?></strong>
                    </td>
                </tr>
                </thead>
    ...
    <tr>
        ...
        <td class="input_tab">
            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
                <tr>
                    <td colspan="3" align="center" nowrap="nowrap"><strong><?php echo $strDeleteRelation; ?></strong>
                    </td>
                </tr>
                <tr>
