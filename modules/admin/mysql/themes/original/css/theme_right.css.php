...
div.error {
    margin: 0.3em 0 0 0;
    border: 2px solid;
<?php if ($GLOBALS['cfg']['ErrorIconic']) { ?> background-repeat: no-repeat;
...
div.success {
    border-color: #00FF00;
<?php if ($GLOBALS['cfg']['ErrorIconic']) { ?> background-image: url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>s_success.png);
<?php } ?>
}
...
div.notice {
    border-color: #FFD700;
<?php if ($GLOBALS['cfg']['ErrorIconic']) { ?> background-image: url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>s_notice.png);
<?php } ?>
}
...
div.warning {
    border-color: #CC0000;
<?php if ($GLOBALS['cfg']['ErrorIconic']) { ?> background-image: url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>s_warn.png);
<?php } ?>
}
...
div.error {
    border-color: #ff0000;
<?php if ($GLOBALS['cfg']['ErrorIconic']) { ?> background-image: url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>s_error.png);
<?php } ?>
}
...
fieldset.confirmation legend {
    ...
    font-weight: bold;
<?php if ($GLOBALS['cfg']['ErrorIconic']) { ?> background-image: url(<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>s_really.png);
    background-repeat: no-repeat;
<?php if ($GLOBALS['text_dir'] === 'ltr') { ?> background-position: 5px 50%;
    padding: 0.2em 0.2em 0.2em 25px;
<?php } else { ?> background-position: 97% 50%;
...
<?php echo $_SESSION['PMA_Theme']->getImgPath(); ?>   s_rights.png); */
}
